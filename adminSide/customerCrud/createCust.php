...
<div class="legacy-wrapper">
    ...
    <h2 class="pull-left">Create New Membership</h2>
    ...
    <form method="POST" action="success_createMembership.php">
        ...
        <div class="form-group">
            ...
            <input type="text" name="member_name" placeholder="abc" class="form-control <?php echo $member_name_err ? 'is-invalid' : ''; ?>" id="member_name" required value="<?php echo $member_name; ?>"><br>
            <div class="invalid-feedback">
